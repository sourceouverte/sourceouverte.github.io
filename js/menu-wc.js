...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">typescriptds documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            ...
                            <li class="link">
                                <a href="classes/LinkedList.html" data-type="entity-link" >LinkedList</a>
                            </li>
                            <li class="link">
                                <a href="classes/LinkedListNode.html" data-type="entity-link" >LinkedListNode</a>
                            </li>
                            <li class="link">
